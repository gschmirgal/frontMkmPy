...
final class Version20250806152551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE logs (id INT AUTO_INCREMENT NOT NULL, date_import DATETIME NOT NULL, date_import_file DATETIME NOT NULL, date_data DATE DEFAULT NULL, idStep INT DEFAULT NULL, INDEX IDX_F08FC65C3044A0A2 (idStep), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql("INSERT INTO `logsteps` (`id`, `step`) VALUES (10, 'ongoing'), (50, 'OK'), (90, 'too early');");
